...
from utils.logging_utils import init_logger, logger
...
class ReportMgr(ReportMgrBase):
    ...
    def maybe_log_tensorboard(self, stats, prefix, learning_rate, step):
        if self.tensorboard_writer is not None:
            ...
            raise Exception("Your Tensorboard writer is a None obejct, "
                            "please check if you pass a legal writer to this function!")
...
class Statistics(object):
    ...
    * elapsed time
    ...
    def __init__(self, loss=0, n_docs=0, n_correct=0, loss_fn_reduction='mean'):
        self.loss = loss
        self.n_docs = n_docs
        self.start_time = time.time()
        self.loss_fn_reduction = loss_fn_reduction
    ...
    def xent(self):
        ...
        if self.n_docs == 0:
            return 0
        # if self.loss_fn_reduction == 'mean':
        #     return self.loss
        else:
